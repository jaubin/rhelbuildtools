...
Requires: confluent-5.1-common = %{__versrel}
...
Requires: confluent-5.1-kafka-libs = %{__versrel}
Requires: confluent-5.1-kafka-serde-tools = %{__versrel}
...
Requires: confluent-5.1-kafka-connect-storage-common = %{__versrel}
...
Requires: confluent-5.1-schema-registry = %{__versrel}
