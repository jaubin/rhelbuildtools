...
Conflicts:      confluent-5.0-common
Conflicts:      confluent-5.1-common
...
Requires: confluent-5.2-common = %{__versrel}
...
Requires: confluent-5.2-kafka-libs = %{__versrel}
Requires: confluent-5.2-kafka-serde-tools = %{__versrel}
...
Requires: confluent-5.2-kafka-connect-storage-common = %{__versrel}
...
Requires: confluent-5.2-schema-registry = %{__versrel}
